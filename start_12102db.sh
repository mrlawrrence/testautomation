...
ORACLE_HOME=/u01/app/db12102
cd $ORACLE_HOME/clone
THISNODE=`hostname -s`

E01=ORACLE_HOME=/u01/app/db12102
E02=ORACLE_HOME_NAME=OraDB12102
...
C01="-O CLUSTER_NODES={rws3010158,rws3010159,rws3010160,rws3010161}"
